  ...
  >
    <form @submit.prevent="sendEmail">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content pb rt rb">
          ...
          <div class="modal-body">
            <p>Change your password through email validation.</p>
...
export default {
  ...
  data() {
    ...
    return {
      form: {
        email: "",
        subject: "Firestarters - Change Password",
        html: ``,
      },
      result: "",
                ...
                .post(
                    ...
                    process.env.VUE_APP_API_EMAIL_ROUTE,
                  {
                    ...
                    html:
                      ...
                      ` <a href="${firestartersWebsiteURL}/reset-password?token=${res.data[0].sk_value}&email=${this.form.email}">click here to reset your password.</a>`,
                    attachments: [
                      {
