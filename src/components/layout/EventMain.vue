  ...
  <div v-else>
    <div class="row" v-if="events.length !== 0">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <h1 class="diamond-icon">Our Latest Events</h1>
      </div>
    </div>

    <div class="row" v-for="(event, index) in events" :key="event.id">
      <div class="col-lg-12 col-md-12 col-sm-12" v-if="index == 0">
        <!--Event image-->
        <router-link
          :to="{ path: '/events/' + event.id + '/' + event.e_canonical_title }"
        >
          <img
            role="img"
